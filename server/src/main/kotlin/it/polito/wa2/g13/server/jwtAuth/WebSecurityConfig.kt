...
class WebSecurityConfig(private val jwtAuthConverter: JwtAuthConverter) {
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http.csrf().disable()
            ...
            .requestMatchers(HttpMethod.DELETE, "/API/profiles/**").hasAnyRole(CUSTOMER)
            ...
            .requestMatchers(HttpMethod.POST, "/API/changePassword/**").hasAnyRole(MANAGER, EXPERT, CUSTOMER)
